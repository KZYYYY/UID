    ...
    for epoch in range(1, epochs + 1):
        ...
        for i in range(i_ter + 1):
            ...
            with amp.autocast(enabled=True):
                ...
                text_features_view1, text_features_view2, text_features_view3, text_features_view4, text_features_view5, text_features_view6 = model(
                    label=target, get_text=True)  # 获取ID相关文本特征
            ...
            loss_i2t = loss_i2t_view1 + loss_i2t_view2
            loss_t2i = loss_t2i_view1 + loss_t2i_view2
        ...
        if epoch % checkpoint_period == 0 and epoch > 80 or epoch == epochs:
