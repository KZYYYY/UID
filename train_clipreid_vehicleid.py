...
from processor.processor_clipreid_multi_views import do_train_multi_view
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="./configs/veri/vit_prom.yml", help="path to config file", type=str
    )
    ...
    train_set, train_loader_stage2, train_loader_stage1, val_loader, num_query, num_classes, camera_num = make_dataloader(
        cfg)
