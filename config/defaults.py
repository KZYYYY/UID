...
_C.MODEL.KL_LOSS_WEIGHT = 1.0
_C.MODEL.MOE_CONSIST_LOSS_WEIGHT = 1.0
...
# STAGE1 Parameter
_C.MODEL.DA_INS_LOSS_WEIGHT = 0.1
_C.MODEL.MV_RECON_LOSS_WEIGHT = 10.0
_C.MODEL.CLS_INS_LOSS_WEIGHT = 0.2
_C.MODEL.INS_DIS_LOSS_WEIGHT = 1.0
_C.MODEL.STAGE1_I2T_LOSS_WEIGHT = 1.0
_C.MODEL.STAGE1_T2I_LOSS_WEIGHT = 1.0
