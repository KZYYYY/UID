...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config_file", default="./configs/veri/cnn_prom.yml", help="path to config file", type=str
    )
    ...
    train_set, train_loader_stage2, train_loader_stage1, val_loader, num_query, num_classes, camera_num, view_num = make_dataloader(
        cfg)
    ...
    # model.load_param_finetune('./results/veri_reid/ViT-based-CoOp/RN50_stage1_60.pth')
